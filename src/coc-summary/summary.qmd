...
|Id  |Data|Ingested|
|:-|:----|-:|
|2713|Benin - Health Results-Based Financing Impact Evaluation Survey 2010-2011, Baseline - 2010||
|2732|Burkina Faso - Health Results-Based Financing Impact Evaluation 2013, Health Facility Baseline Survey - 2013||
...
|2768|Congo, Dem. Rep. - Health Results Based Financing Impact Evaluation 2015, Health Facility Baseline Survey - 2015||
...
## Consultation lengths vary by facililty

![ Consultation lengths vary by facililty](benin_consult_length_by_facility.png){#fig-ben-by-hf}

# Identify determinants of the length of consultation

We used regression analyses to identify determinants of the length of an ANC consultation in Benin. We started with a full model that incorportated
attributes of the health facility, patient, healthcare worker, and the appointment.

* log-transformed the consultation length
* The initial model specification used:
** rural/urban location of the health-facility
** healthzone
** number of staff
** catchment population
** total attendance in 2009
** whether pregnant women have private space
** number of maternal deaths in the last 12 months
** whether women in labour pay for the equipment
** healthcare worker qualification
** whether this was patient's first ANC
** trimester of pregnancy
** hour at which consultation began

The model is fitted to 311 rows, which contain information on all variables.
That is, 390 rows are excluded.
