...
saveRDS(coeffs_gt_0, file = "bfa_both_dco_bayes_coeffs_gt_0.rds")
orderly_artefact(
  files = "bfa_both_dco_bayes_coeffs_gt_0.rds",
...
ggsave_manuscript(
  "bfa_both_dco_bayes_coeffs_gt_0",
  plot = p, width = 12, height = 8
)

orderly_artefact(
  files = "bfa_both_dco_bayes_coeffs_gt_0.rds",
  description = "Coefficients greater than 0 for BFA model fits"
)
